...
<div class="head" style="float:right;margin-top:10px;margin-right:20px;">
    ...
    <c:if test="${name != null }"><a
            href="logout.action">注销</a>|<a href="updatepassword.jsp">修改密码</a>|<a href="Http://mail.unitchem.net/">邮箱</a></c:if>
</div>
<div class="wrap">
    ...
    <div class="left">
        ...
        <div class="blank">
            <ul>
                <li><A href="companyhistory.jsp"><img src="image/cs1.png"></A></li>
                <li><A href="companydevelopment.jsp"><img src="image/cs2.png"></A></li>
            </ul>
        </div>
        <div>
            <ul>
    ...
    <div class="right"><img src="image/comop.PNG">
        <!-- <table>
            <tr>
                <td>2006</td>
                <td>Shanghai Unitchem Co., ltd established </td>
            <tr>
            <tr> <td></td><td>R&D, QA&QC lab established</td></tr>
            <tr> <td></td><td>First production of intermediate of Desogestrel </td></tr>
            <tr> <td>2008</td><td>Start Agrochemcial intermediates business. </td></tr>
            <tr> <td></td><td>First intermediates tolling business:2-Cyanophenol</td></tr>
            <tr> <td></td><td>Start production of Estriol</td></tr>
            <tr> <td>2010</td><td>Start production of intermediate of Etonogestrel</td></tr>
            <tr> <td></td><td>Wuxi Unitchem Co., ltd established, same time transfer all the Agrochemical business to Wuxi Unitchem. Later 2010, moved R&D, QA&QC for Agrochemicals to Wuxi Unitchem.</td></tr>
            <tr> <td>2011</td><td>Shandong Factory was founded, mainly focus on the produciton of Agrochemical intermediates.</td></tr>
